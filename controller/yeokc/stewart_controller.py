...
class Stewart_Platform(object):   
    ...
    def __init__(s, r_B, r_P, lhl, ldl, gamma_B, gamma_P, ref_rotation):
        ...
        beta_angle = -35
        beta = np.radians(np.array([ # TODO: What is this beta?
            -beta_angle,        
            beta_angle,
            120 - beta_angle, 
            120 + beta_angle,
    ...
    def plot_platform(s):
        ...
        hexagon_vertices = np.transpose(s.B)  # Convert to a list of points for easier iteration.
        ...
        for i, (x, y, z) in enumerate(hexagon_vertices):
            ax.text(x, y, z, f'{i + 1}', color='black', fontsize=10)
